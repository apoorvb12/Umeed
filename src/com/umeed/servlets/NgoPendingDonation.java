...
/**
 * Servlet implementation class NgoPendingDonation
 */
@WebServlet("/NgoPendingDonation")
public class NgoPendingDonation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NgoPendingDonation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("ngoId") != null) {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"										<a class=\"nav-link\">Pending Donations</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item\">\r\n" + 
			...
			ArrayList<Donation> donation = DonationDao.findAllByNgoStatusNo(ngoId);
			if(donation.size() != 0) {
			out.println("<table>\r\n" + 
					"				<tr>\r\n" + 
					"					<th>Sr No.</th>\r\n" + 
			...
			out.println("<tr>\r\n" + 
					...
					"					<td>" + volunteer.getContactNumber()+ "</td>\r\n" + 
					"				</tr>");
			}
			out.println("</table>");
			}else {
				out.println("<br><p style=\"color:#FF0000\">No Pending Donations.</p>");
			}
			out.println("</form>\r\n" + 
					"\r\n" + 
					"	</div>\r\n" + 
