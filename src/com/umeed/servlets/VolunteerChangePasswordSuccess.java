...
/**
 * Servlet implementation class VolunteerChangePasswordSuccess
 */
@WebServlet("/VolunteerChangePasswordSuccess")
public class VolunteerChangePasswordSuccess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VolunteerChangePasswordSuccess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(VolunteerDao.checkPassword(password, volunteerId)) {
			VolunteerDao.changeVolunteerPassword(newPassword, volunteerId);
			response.sendRedirect("/Umeed/VolunteerProfile");
		}else {
			...
			out.println("<div class=\"signup-form1\">\r\n" + 
					"    <form  method=\"post\" action=\"/Umeed/VolunteerChangePasswordSuccess\" onsubmit=\"return checkPassword(this);\">\r\n" + 
