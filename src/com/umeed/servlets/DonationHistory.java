	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("donorId") != null) {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"										<a class=\"nav-link\">Donation History</a>\r\n" + 
					"									</li>\r\n" + 
					...
					"			\r\n");
			ArrayList<Donation> donation = DonationDao.findAllByStatusYes((Integer)session.getAttribute("donorId"));
			if(donation.size() != 0) {
						out.println("<table>\r\n" + 
						"				<tr>\r\n" + 
						"					<th>Sr No.</th>\r\n" + 
					...
					for(Donation d : donation) {
						...
						out.println("<tr>\r\n" + 
								...
								"					<td>" + date + "</td>\r\n" + 
								"					<td>" + location.getAddress().toUpperCase() + "</td>\r\n" + 
								"					<td>" + delivery_date + "</td>\r\n" +
								"				</tr>");
					}
					out.println("</table>");
			}else {		
				out.println("<br><p style=\"color:#FF0000\">No Donations done yet.</p>");
			}
			out.println("</form>\r\n" + 
					"\r\n" + 
					"	</div>\r\n" + 
