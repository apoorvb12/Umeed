...
public class VolunteerProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("volunteerId") != null) {
			...
			"									</li>\r\n" + 
			"									<li class=\"nav-item\">\r\n" + 
			"										<a class=\"nav-link\" href=\"/Umeed/VolunteerDonationDelivered\">Donations Delivered</a>\r\n" + 
			"									</li>\r\n" + 
			...
			out.println("<div class=\"signup-form2\">\r\n" + 
					"    <form  method=\"post\" action=\"/Umeed/VolunteerChangePassword\">\r\n" + 
					"		<h2>Volunteer Profile</h2><br>\r\n" + 
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:91px;color:#ea2c58\">Ngo Name </b>: &nbsp" + volunteer.getName().toUpperCase() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        \r\n" + 
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:43px;color:#ea2c58\"> Ngo Contact No. </b>: &nbsp" + volunteer.getContactNumber() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        \r\n" + 
					"		<div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:131px;color:#ea2c58\">Email </b>: &nbsp" + volunteer.getEmail() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 

					"       <div class=\"form-group\">\r\n" + 
					"				<p><h4><b style=\"padding-right:109px;color:#ea2c58\">Address </b>: &nbsp" + volunteer.getArea().trim().toUpperCase() +" "+ volunteer.getCity().trim().toUpperCase() + "</h4></p> 	\r\n" + 
					"	        </div>\r\n" + 				
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b  style=\"padding-right:10px;color:#ea2c58\">Total Deliveries Done</b>: &nbsp" + VolunteerDao.donationReceived(volunteerId) + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        <div class=\"form-group\">\r\n" + 
