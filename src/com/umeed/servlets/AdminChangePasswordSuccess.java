...
import com.umeed.pojos.Admin;

/**
 * Servlet implementation class AdminChangePasswordSuccess
 */
@WebServlet("/AdminChangePasswordSuccess")
public class AdminChangePasswordSuccess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminChangePasswordSuccess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(AdminDao.find(adminId).getPassword().equals(password)) {
			Admin admin = AdminDao.find(adminId);
			admin.setPassword(newPassword);
			AdminDao.edit(admin);
			response.sendRedirect("/Umeed/AdminPending");
		}else {
