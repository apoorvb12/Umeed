...
/**
 * Servlet implementation class NgoDonationReceived
 */
@WebServlet("/NgoDonationReceived")
public class NgoDonationReceived extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NgoDonationReceived() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int ngoId = 0;
		String ngoName = new String();
		String ngoEmail = new String();
		if (session.getAttribute("ngoId") != null) {
			ngoId = (Integer) session.getAttribute("ngoId");
			ngoName = (String) session.getAttribute("ngoName");
			ngoEmail = (String) session.getAttribute("ngoEmail");
			...
			out.println("<!doctype html>\r\n" + 
					...
					"	<title>Donations Received</title>\r\n" + 
					"	<!-- Bootstrap CSS -->\r\n" + 
					...
					"										<a class=\"nav-link\">Donations Received</a>\r\n" + 
					"									</li>\r\n" + 
					...
					"											<li class=\"nav-item\">\r\n" + 
					"												<a class=\"nav-link\" href=\"/Umeed/NgoProfile\">Profile</a>\r\n" + 
					"											</li>\r\n" + 
					"											<li class=\"nav-item\">\r\n" + 
			...
			ArrayList<Donation> donation = DonationDao.findAllByNgoStatusYes(ngoId);
			if(donation.size() != 0) {
				out.println("<table>\r\n" + 
						"				<tr>\r\n" + 
						"					<th>Sr No.</th>\r\n" + 
				...
				out.println("</table>");
					...
					out.println("<br><p style=\"color:#FF0000\">No Donations Received.</p>");
				}
				out.println("</form>\r\n" + 
						"\r\n" + 
						"	</div>\r\n" + 
