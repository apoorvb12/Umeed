...
/**
 * Servlet implementation class VolunteerPending
 */
@WebServlet("/VolunteerPending")
public class VolunteerPending extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VolunteerPending() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("volunteerId") != null) {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"										<a class=\"nav-link\" >Pending Requests</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item\">\r\n" + 
			...
			ArrayList<Donation> donation = DonationDao.findAllByVolunteerStatusNo((Integer)session.getAttribute("volunteerId"));
			if(donation.size() != 0) {
				out.println("<table>\r\n" + 
						"				<tr>\r\n" + 
						"					<th>Sr No. </th>\r\n" + 
				...
				for(Donation d : donation) {
					...
					out.println("<tr>\r\n" + 
							...
							"					<td><input type=\"submit\" formaction=\"/Umeed/VolunteerPendingSuccess?status="+ d.getDonationId() +" \" value=\"Donated Successfully\"></td>\r\n" + 
							"	</tr>");
				}
					out.println("</table>");
