...
/**
 * Servlet implementation class NgoProfile
 */
@WebServlet("/NgoProfile")
public class NgoProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int ngoId = 0;
		if (session.getAttribute("ngoId") != null) {
			ngoId = (Integer) session.getAttribute("ngoId");
			...
			out.println("<!doctype html>\r\n" + 
					...
					"									<li class=\"nav-item\">\r\n" + 
					"										<a class=\"nav-link\">Non Governmental Organisation</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item\">\r\n" + 
					"										<a class=\"nav-link\"  href=\"/Umeed/NgoPendingDonation\">Pending Donations</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item\">\r\n" + 
					"										<a class=\"nav-link\" href=\"/Umeed/NgoDonationReceived\">Donations Received</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item submenu dropdown\">\r\n" + 
					"										<a href=\"#\" class=\"main_btn1\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">"+session.getAttribute("ngoName")+"</a>\r\n" + 
					"										<ul class=\"dropdown-menu\">\r\n" + 
					"											<li class=\"nav-item\">\r\n" + 
					"												<a class=\"nav-link\">Profile</a>\r\n" + 
					"											</li>\r\n" + 
					"											<li class=\"nav-item\">\r\n" + 
					"												<a class=\"nav-link\" href=\"/Umeed/NgoLogout\">Log Out</a>\r\n" + 
					"											</li>\r\n" + 
					"										</ul>\r\n" + 
					"									</li>\r\n" + 
					"								</ul>\r\n" + 
			...
			out.println("<div class=\"signup-form2\">\r\n" + 
					"    <form  method=\"post\" action=\"/Umeed/NgoChangePassword\">\r\n" + 
					"		<h2>NGO Profile</h2><br>\r\n" + 
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:116px;color:#ea2c58\">Ngo Name </b>: &nbsp" + ngo.getName().toUpperCase() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        \r\n" + 
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:68px;color:#ea2c58\"> Ngo Contact No. </b>: &nbsp" + ngo.getContactNumber() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        \r\n" + 
					"		<div class=\"form-group\">\r\n" + 
					"			<p><h4><b style=\"padding-right:156px;color:#ea2c58\">Email </b>: &nbsp" + ngo.getEmail() + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 

					"       <div class=\"form-group\">\r\n" + 
					"				<p><h4><b style=\"padding-right:134px;color:#ea2c58\">Address </b>: &nbsp" + ngo.getAddress().toUpperCase() + "</h4></p> 	\r\n" + 
					"	        </div>\r\n" + 
					"	    <div class=\"form-group\">\r\n" + 
					"					<p><h4><b style=\"padding-right:97px;color:#ea2c58\">Owner Name </b>: &nbsp" + ngo.getOwnerName().toUpperCase() + "</h4></p> 	\r\n" + 
					"		</div>\r\n" +
					"		<div class=\"form-group\">\r\n" + 
					"				<p><h4><b style=\"padding-right:49px;color:#ea2c58\">Owner Contact No. </b>: &nbsp" + ngo.getOwnerNumber() + "</h4></p> 	\r\n" + 
					"		 </div>\r\n" +
					"		 <div class=\"form-group\">\r\n" + 
					"							<p><h4><b style=\"padding-right:100px;color:#ea2c58\">Owner Email </b>: &nbsp" + ngo.getOwnerEmail() + "</h4></p> 	\r\n" + 
					"		  </div>\r\n" +					
					"        <div class=\"form-group\">\r\n" + 
					"			<p><h4><b  style=\"padding-right:10px;color:#ea2c58\">Total Donation Received</b>: &nbsp0" + NgoDao.donationReceived(ngoId) + "</h4></p> 	\r\n" + 
					"        </div>\r\n" + 
					"        <div class=\"form-group\">\r\n" + 
					"            <button type=\"submit\" style=\"width:fit-content\"  class=\"btn btn-success btn-lg btn-block\">Change Password</button>\r\n" + 
					"        </div></form>\r\n" + 
					"        \r\n" + 
					"\r\n" + 
					"\r\n" + 
			...
			response.sendRedirect("/Umeed/Display/NgoLogin.html");
		}
	}
