...
/**
 * Servlet implementation class AdminDonation
 */
@WebServlet("/AdminDonation")
public class AdminDonation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("adminId") != null) {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"										<a class=\"nav-link\">Total Donations</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item\">\r\n" + 
					...
					"");
			ArrayList<Donation> donation = DonationDao.findAllByYes();
			if(donation.size() != 0) {
				out.println("<table>\r\n" + 
						"				<tr>\r\n" + 
						"					<th>Sr No.</th>\r\n" + 
				...
				for(Donation d : donation) {
					...
					String delivery_date = format.format(d.getDateTime());
