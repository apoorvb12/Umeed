...
/**
 * Servlet implementation class DonorCurrentStatus
 */
@WebServlet("/DonorCurrentStatus")
public class DonorCurrentStatus extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DonorCurrentStatus() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("donorId") != null) {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"	<title>Current/Pending Status</title>\r\n" + 
					"	<!-- Bootstrap CSS -->\r\n" + 
					...
					"										<a class=\"nav-link\">Current/Pending Status</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item \">\r\n" + 
					"										<a class=\"nav-link\" href=\"/Umeed/DonationHistory\">Donation History</a>\r\n" + 
					"									</li>\r\n" + 
					"									<li class=\"nav-item submenu dropdown\">\r\n" + 
					"										<a href=\"#\" class=\"main_btn1\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">" + session.getAttribute("donorName") + "</a>\r\n" + 
			...
			out.println("<div class=\"signup-form2\">\r\n" + 
					...
					"			\r\n" );
			ArrayList<Donation> donation = DonationDao.findAllByStatusNo((Integer)session.getAttribute("donorId"));
			if(donation.size() != 0) {
				out.println("<table>\r\n" + 
						"				<tr>\r\n" + 
						"					<th>Sr No.</th>\r\n" + 
