...
/**
 * Servlet implementation class DonorChangePasswordSuccess
 */
@WebServlet("/DonorChangePasswordSuccess")
public class DonorChangePasswordSuccess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DonorChangePasswordSuccess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(DonorDetailsDao.checkPassword(password, donorId)) {
			DonorDetailsDao.changeDonorPassword(newPassword, donorId);
			response.sendRedirect("/Umeed/DonorProfileServlet");
		}else {
			...
			out.println("<!doctype html>\r\n" + 
					...
					"	<link rel=\"stylesheet\" href=\"/Umeed/Resources/css/logcss2.css\">\r\n" + 
					"</head>\r\n" + 
					"\r\n" + 
					"<body>\r\n" + 
					"\r\n" + 
					...
					"											<li class=\"nav-item\">\r\n" + 
					"												<a class=\"nav-link\" href=\"/Umeed/DonorProfileServlet\">Profile</a>\r\n" + 
					"											</li>\r\n" + 
					"											<li class=\"nav-item\">\r\n" + 
					...
					"    <form  method=\"post\" action=\"/Umeed/DonorChangePasswordSuccess\" onsubmit=\"return checkPassword(this);\">\r\n" + 
