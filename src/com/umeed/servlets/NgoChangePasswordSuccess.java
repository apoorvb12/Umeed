...
/**
 * Servlet implementation class NgoChangePasswordSuccess
 */
@WebServlet("/NgoChangePasswordSuccess")
public class NgoChangePasswordSuccess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NgoChangePasswordSuccess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int ngoId =  (Integer) session.getAttribute("ngoId");
		String password = request.getParameter("current_password");
		String newPassword = request.getParameter("password1");
		if(NgoDao.checkPassword(password, ngoId)) {
			NgoDao.changeNgoPassword(newPassword, ngoId);
			response.sendRedirect("/Umeed/NgoProfile");
		}else {
			...
			out.println("<div class=\"signup-form1\">\r\n" + 
					"    <form  method=\"post\" action=\"/Umeed/NgoChangePasswordSuccess\" onsubmit=\"return checkPassword(this);\">\r\n" + 
					"		<h2>Change Password</h2><p style=\"color:#FF0000\">Incorrect Current Password</p>\r\n" + 
					"        \r\n" + 
